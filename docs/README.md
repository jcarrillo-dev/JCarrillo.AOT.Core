# Documentación Técnica de JCarrillo.AOT.Core

Bienvenido al sitemap de documentación técnica del proyecto. A continuación se detallan los accesos a los distintos módulos de alto rendimiento e infraestructura crítica:
